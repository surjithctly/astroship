const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/wiselydesk",
      icon: (props) => (
    ...
    {
      name: "GitHub",
      href: "https://github.com/WiselyDesk",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UCfr2P78VJdfQTynwOLzyuKA",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 opacity-60">
              Revamp your Help Center CX with AI. Get instant answers about your
